...
public class AdapterListViewFriends extends ArrayAdapter {

    private List<FriendsClass> friendsClassList;
    private int resource;
    private LayoutInflater layoutInflater;

    public AdapterListViewFriends(Context context, int resource, List<FriendsClass> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ivPhoto = (ImageView)convertView.findViewById(R.id.imageViewUserPhoto);
        tvNameSurname = (TextView)convertView.findViewById(R.id.textViewUserNameSurname);
        tvEmail = (TextView)convertView.findViewById(R.id.textViewUserEmail);
